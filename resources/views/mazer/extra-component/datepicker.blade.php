...
@push('styles')
<link rel="stylesheet" href="{{ asset('template/mazer/extensions/flatpickr/flatpickr.min.css') }}">
@endpush

@push('scripts')
<script src="{{ asset('template/mazer/extensions/flatpickr/flatpickr.min.js') }}"></script>
<script src="{{ asset('template/mazer/static/js/pages/date-picker.js') }}"></script>
@endpush
