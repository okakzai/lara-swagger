...
@push('styles')
<link rel="stylesheet" href="{{ asset('template/mazer/extensions/choices.js/public/assets/styles/choices.css') }}">
@endpush

@push('scripts')
<script src="{{ asset('template/mazer/extensions/choices.js/public/assets/scripts/choices.js') }}"></script>
<script src="{{ asset('template/mazer/static/js/pages/form-element-select.js') }}"></script>
@endpush
